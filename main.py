...
def usage():
    ...
    print('    0 or a negative value means no limit. In this case stop with ^C.')
    print('')
    ...
    print('    stats.csv,   containing tweetCount, views and tfidf, etc. for each topic (TAB seperated values)')
    print('    sentimentStats.json, containing numbers of positive, negative, neutral and total tweets')
    print('')
