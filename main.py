...
def usage():
    ...
    print('    ‘filter <terms>’ streams a live sample 1000 tweets, filtered by given terms, if any')
    print('    ‘news [date]’ will retrieve news from UK sources of the given date (which must be in YYYY-MM-DD format) or today if not date is given')
